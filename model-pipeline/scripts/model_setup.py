...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Legacy: single root for pipeline+model outputs.",
    )
    parser.add_argument(
        "--pipeline-data-dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="",
        help="Root for translation_inputs in / predictions out (default: data/model_runs).",
    )
    parser.add_argument(
        "--max-rows",
        type=int,
    ...
    if inputs_path is not None:
        ...
        if not manifest:
            print(
                ...
                "Run build_translation_inputs_from_audio.py or add translation_inputs under data/model_runs/<split>/."
            )
            sys.exit(0)
